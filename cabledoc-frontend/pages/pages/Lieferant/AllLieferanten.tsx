...
import ReactTable from "../table/ReactTable"; // Stellen Sie sicher, dass Ihr Pfad korrekt ist
...
export default function AllLieferanten() {
  ...
  if (!lieferanten || !lieferanten.hasOwnProperty("data")) {
  ...
  if (!lieferanten) {
    return <div>No Lieferanten data found.</div>;
  }
