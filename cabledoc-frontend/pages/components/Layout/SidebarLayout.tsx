...
import { useUserStore } from "../../../app/api/user"; // Passen Sie den Importpfad entsprechend an
import type { NavbarConfig } from "../../types/navbar"; // Passen Sie den Importpfad entsprechend an
import "./SidebarLayout.css"; // Passen Sie den Importpfad entsprechend an
import { getHeight, getWidth } from "./getClassNames";
import * as styles from "./tailwindStyles";
